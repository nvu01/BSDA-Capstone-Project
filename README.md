...
All notebooks are in `notebooks/` folder. Run the notebooks in the following order:
...
All input and output datasets are in `data/` folder.

| File                   | Description |
|------------------------|---|
| `s_vars.json`          | Raw data from ACS Subject Tables |
| `dp_vars.json`         | Raw data from ACS Data Profiles |
| `b_vars.json`          | Raw data from ACS Detailed Tables |
...
| Path                               | Description |
|------------------------------------|---|
| `scripts/retrieve_variable_codes.py` | Script for looking up variable codes in ACS metadata |
| `html/`                       | HTML exports of all notebooks |
